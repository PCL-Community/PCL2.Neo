            ...
            new()
            {
                ...
                Children =
                {
                    new KeyFrame
                    {
                        Setters =
                        {
                            new Setter(ScaleTransform.ScaleXProperty, Before),
                            new Setter(ScaleTransform.ScaleYProperty, Before)
                        },
                        Cue = new Cue(0d)
                    },
                    new KeyFrame
                    {
                        Setters =
                        {
                            new Setter(ScaleTransform.ScaleXProperty, After),
                            new Setter(ScaleTransform.ScaleYProperty, After)
                        },
                        Cue = new Cue(1d)
                    }
                }
