...
using DeviceCodeMode = PCL2.Neo.Service.MicrosoftAuth.DeviceCodeMode;
...
public interface IMicrosoftAuthService
{
    ...
    Task<Result<AccountInfo.OAuthTokenData, Exception>> RefreshTokenAsync(string refreshToken);
}